...
extension Stripe.Billing.Customer.Portal.Configuration.Client {
    public static func live(
        makeRequest: @escaping @Sendable (_ route: Stripe.Billing.Customer.Portal.Configuration.API) throws -> URLRequest
    ) -> Self {
...
extension Stripe.Billing.Customer.Portal.Configuration: @retroactive DependencyKey {
    ...
    public static let testValue: Stripe.Billing.Customer.Portal.Configuration.Authenticated = liveValue
}
